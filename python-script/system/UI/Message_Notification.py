...
class MessageNotification(QWidget):
    ...
    def showMessage(
        parent,
        *message: str | tuple,
        open_file_path: str = None,
        position: str = 'bottom',
        offset: int = 20,
        flag_move_in: bool = True,
        flag_move_out: bool = True,
        hold_duration: int = 2000,
        fade_in_duration: int = 1000,
        fade_out_duration: int = 500,
        move_duration: int = 500,
        move_in_point: tuple[str | int | None, str | int | None] = None,
        background_color: str = 'rgba(0, 0, 0, 200)',
        padding: int = 10,
        border_width: int = 1,
        ...
        message_widget = MessageNotification(
            parent,
            position,
            offset,
            flag_move_in,
        ...
        message_widget.notification(*message, open_file_path=open_file_path)
    ...
    def __open_excel_folder(self, file_path: str):
        if not file_path or not os.path.os.path.exists(file_path):
            return
