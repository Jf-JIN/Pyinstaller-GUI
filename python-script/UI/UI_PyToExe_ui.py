...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pb_add_file_folder_data = QPushButton(self.widget_31)
        self.pb_add_file_folder_data.setObjectName(u"pb_add_file_folder_data")
        sizePolicy1.setHeightForWidth(self.pb_add_file_folder_data.sizePolicy().hasHeightForWidth())
        self.pb_add_file_folder_data.setSizePolicy(sizePolicy1)
        self.pb_add_file_folder_data.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout.addWidget(self.pb_add_file_folder_data, 0, 0, 1, 1)

        self.pb_add_binary_data = QPushButton(self.widget_31)
        self.pb_add_binary_data.setObjectName(u"pb_add_binary_data")
        sizePolicy1.setHeightForWidth(self.pb_add_binary_data.sizePolicy().hasHeightForWidth())
        self.pb_add_binary_data.setSizePolicy(sizePolicy1)
        self.pb_add_binary_data.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout.addWidget(self.pb_add_binary_data, 0, 1, 1, 1)

        self.pb_collect_submodules = QPushButton(self.widget_31)
        self.pb_collect_submodules.setObjectName(u"pb_collect_submodules")
        sizePolicy1.setHeightForWidth(self.pb_collect_submodules.sizePolicy().hasHeightForWidth())
        self.pb_collect_submodules.setSizePolicy(sizePolicy1)
        self.pb_collect_submodules.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout.addWidget(self.pb_collect_submodules, 0, 2, 1, 1)

        self.pb_collect_data = QPushButton(self.widget_31)
        self.pb_collect_data.setObjectName(u"pb_collect_data")
        sizePolicy1.setHeightForWidth(self.pb_collect_data.sizePolicy().hasHeightForWidth())
        self.pb_collect_data.setSizePolicy(sizePolicy1)
        self.pb_collect_data.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout.addWidget(self.pb_collect_data, 1, 0, 1, 1)

        self.pb_collect_binaries = QPushButton(self.widget_31)
        self.pb_collect_binaries.setObjectName(u"pb_collect_binaries")
        sizePolicy1.setHeightForWidth(self.pb_collect_binaries.sizePolicy().hasHeightForWidth())
        self.pb_collect_binaries.setSizePolicy(sizePolicy1)
        self.pb_collect_binaries.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout.addWidget(self.pb_collect_binaries, 1, 1, 1, 1)

        self.pb_collect_all = QPushButton(self.widget_31)
        self.pb_collect_all.setObjectName(u"pb_collect_all")
        sizePolicy1.setHeightForWidth(self.pb_collect_all.sizePolicy().hasHeightForWidth())
        self.pb_collect_all.setSizePolicy(sizePolicy1)
        self.pb_collect_all.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout.addWidget(self.pb_collect_all, 1, 2, 1, 1)

        self.pb_add_splash_screen = QPushButton(self.widget_31)
        self.pb_add_splash_screen.setObjectName(u"pb_add_splash_screen")
        sizePolicy1.setHeightForWidth(self.pb_add_splash_screen.sizePolicy().hasHeightForWidth())
        self.pb_add_splash_screen.setSizePolicy(sizePolicy1)
        self.pb_add_splash_screen.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.pb_hidden_import = QPushButton(self.widget_81)
        self.pb_hidden_import.setObjectName(u"pb_hidden_import")
        sizePolicy1.setHeightForWidth(self.pb_hidden_import.sizePolicy().hasHeightForWidth())
        self.pb_hidden_import.setSizePolicy(sizePolicy1)
        self.pb_hidden_import.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_2.addWidget(self.pb_hidden_import, 0, 0, 1, 1)

        self.pb_imports_paths = QPushButton(self.widget_81)
        self.pb_imports_paths.setObjectName(u"pb_imports_paths")
        sizePolicy1.setHeightForWidth(self.pb_imports_paths.sizePolicy().hasHeightForWidth())
        self.pb_imports_paths.setSizePolicy(sizePolicy1)
        self.pb_imports_paths.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_2.addWidget(self.pb_imports_paths, 0, 1, 1, 1)

        self.pb_exclude_module = QPushButton(self.widget_81)
        self.pb_exclude_module.setObjectName(u"pb_exclude_module")
        sizePolicy1.setHeightForWidth(self.pb_exclude_module.sizePolicy().hasHeightForWidth())
        self.pb_exclude_module.setSizePolicy(sizePolicy1)
        self.pb_exclude_module.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.pb_copy_metadata = QPushButton(self.widget)
        self.pb_copy_metadata.setObjectName(u"pb_copy_metadata")
        sizePolicy1.setHeightForWidth(self.pb_copy_metadata.sizePolicy().hasHeightForWidth())
        self.pb_copy_metadata.setSizePolicy(sizePolicy1)
        self.pb_copy_metadata.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_3.addWidget(self.pb_copy_metadata, 0, 0, 1, 1)

        self.pb_recursive_copy_metadata = QPushButton(self.widget)
        self.pb_recursive_copy_metadata.setObjectName(u"pb_recursive_copy_metadata")
        sizePolicy1.setHeightForWidth(self.pb_recursive_copy_metadata.sizePolicy().hasHeightForWidth())
        self.pb_recursive_copy_metadata.setSizePolicy(sizePolicy1)
        self.pb_recursive_copy_metadata.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.pb_additional_hooks_dir = QPushButton(self.widget_33)
        self.pb_additional_hooks_dir.setObjectName(u"pb_additional_hooks_dir")
        sizePolicy1.setHeightForWidth(self.pb_additional_hooks_dir.sizePolicy().hasHeightForWidth())
        self.pb_additional_hooks_dir.setSizePolicy(sizePolicy1)
        self.pb_additional_hooks_dir.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_4.addWidget(self.pb_additional_hooks_dir, 0, 0, 1, 1)

        self.pb_runtime_hook = QPushButton(self.widget_33)
        self.pb_runtime_hook.setObjectName(u"pb_runtime_hook")
        sizePolicy1.setHeightForWidth(self.pb_runtime_hook.sizePolicy().hasHeightForWidth())
        self.pb_runtime_hook.setSizePolicy(sizePolicy1)
        self.pb_runtime_hook.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.pb_runtime_tmpdir = QPushButton(self.widget_82)
        self.pb_runtime_tmpdir.setObjectName(u"pb_runtime_tmpdir")
        sizePolicy1.setHeightForWidth(self.pb_runtime_tmpdir.sizePolicy().hasHeightForWidth())
        self.pb_runtime_tmpdir.setSizePolicy(sizePolicy1)
        self.pb_runtime_tmpdir.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_5.addWidget(self.pb_runtime_tmpdir, 0, 0, 1, 1)

        self.pb_workpath_option = QPushButton(self.widget_82)
        self.pb_workpath_option.setObjectName(u"pb_workpath_option")
        sizePolicy1.setHeightForWidth(self.pb_workpath_option.sizePolicy().hasHeightForWidth())
        self.pb_workpath_option.setSizePolicy(sizePolicy1)
        self.pb_workpath_option.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_5.addWidget(self.pb_workpath_option, 0, 1, 1, 1)

        self.pb_specpath = QPushButton(self.widget_82)
        self.pb_specpath.setObjectName(u"pb_specpath")
        sizePolicy1.setHeightForWidth(self.pb_specpath.sizePolicy().hasHeightForWidth())
        self.pb_specpath.setSizePolicy(sizePolicy1)
        self.pb_specpath.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_5.addWidget(self.pb_specpath, 0, 2, 1, 1)

        self.cb_noupx_option = QCheckBox(self.widget_82)
        self.cb_noupx_option.setObjectName(u"cb_noupx_option")
        sizePolicy1.setHeightForWidth(self.cb_noupx_option.sizePolicy().hasHeightForWidth())
        self.cb_noupx_option.setSizePolicy(sizePolicy1)
        self.cb_noupx_option.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_5.addWidget(self.cb_noupx_option, 1, 0, 1, 1)

        self.pb_upx_dir = QPushButton(self.widget_82)
        self.pb_upx_dir.setObjectName(u"pb_upx_dir")
        sizePolicy1.setHeightForWidth(self.pb_upx_dir.sizePolicy().hasHeightForWidth())
        self.pb_upx_dir.setSizePolicy(sizePolicy1)
        self.pb_upx_dir.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_5.addWidget(self.pb_upx_dir, 1, 1, 1, 1)

        self.pb_upx_exclude = QPushButton(self.widget_82)
        self.pb_upx_exclude.setObjectName(u"pb_upx_exclude")
        sizePolicy1.setHeightForWidth(self.pb_upx_exclude.sizePolicy().hasHeightForWidth())
        self.pb_upx_exclude.setSizePolicy(sizePolicy1)
        self.pb_upx_exclude.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.pb_log_level = QPushButton(self.widget_80)
        self.pb_log_level.setObjectName(u"pb_log_level")
        sizePolicy1.setHeightForWidth(self.pb_log_level.sizePolicy().hasHeightForWidth())
        self.pb_log_level.setSizePolicy(sizePolicy1)
        self.pb_log_level.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_6.addWidget(self.pb_log_level, 0, 0, 1, 1)

        self.pb_python_option = QPushButton(self.widget_80)
        self.pb_python_option.setObjectName(u"pb_python_option")
        sizePolicy1.setHeightForWidth(self.pb_python_option.sizePolicy().hasHeightForWidth())
        self.pb_python_option.setSizePolicy(sizePolicy1)
        self.pb_python_option.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_6.addWidget(self.pb_python_option, 0, 1, 1, 1)

        self.pb_debug_mode = QPushButton(self.widget_80)
        self.pb_debug_mode.setObjectName(u"pb_debug_mode")
        sizePolicy1.setHeightForWidth(self.pb_debug_mode.sizePolicy().hasHeightForWidth())
        self.pb_debug_mode.setSizePolicy(sizePolicy1)
        self.pb_debug_mode.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_6.addWidget(self.pb_debug_mode, 0, 2, 1, 1)

        self.cb_disable_traceback = QCheckBox(self.widget_80)
        self.cb_disable_traceback.setObjectName(u"cb_disable_traceback")
        sizePolicy1.setHeightForWidth(self.cb_disable_traceback.sizePolicy().hasHeightForWidth())
        self.cb_disable_traceback.setSizePolicy(sizePolicy1)
        self.cb_disable_traceback.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_6.addWidget(self.cb_disable_traceback, 1, 0, 1, 1)

        self.cb_ignore_signals = QCheckBox(self.widget_80)
        self.cb_ignore_signals.setObjectName(u"cb_ignore_signals")
        sizePolicy1.setHeightForWidth(self.cb_ignore_signals.sizePolicy().hasHeightForWidth())
        self.cb_ignore_signals.setSizePolicy(sizePolicy1)
        self.cb_ignore_signals.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_6.addWidget(self.cb_ignore_signals, 1, 1, 1, 1)

        self.cb_noconfirm_option = QCheckBox(self.widget_80)
        self.cb_noconfirm_option.setObjectName(u"cb_noconfirm_option")
        sizePolicy1.setHeightForWidth(self.cb_noconfirm_option.sizePolicy().hasHeightForWidth())
        self.cb_noconfirm_option.setSizePolicy(sizePolicy1)
        self.cb_noconfirm_option.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_6.addWidget(self.cb_noconfirm_option, 1, 2, 1, 1)

        self.cb_strip_option = QCheckBox(self.widget_80)
        self.cb_strip_option.setObjectName(u"cb_strip_option")
        sizePolicy1.setHeightForWidth(self.cb_strip_option.sizePolicy().hasHeightForWidth())
        self.cb_strip_option.setSizePolicy(sizePolicy1)
        self.cb_strip_option.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_6.addWidget(self.cb_strip_option, 2, 0, 1, 1)

        self.cb_clean_cache = QCheckBox(self.widget_80)
        self.cb_clean_cache.setObjectName(u"cb_clean_cache")
        sizePolicy1.setHeightForWidth(self.cb_clean_cache.sizePolicy().hasHeightForWidth())
        self.cb_clean_cache.setSizePolicy(sizePolicy1)
        ...
        self.pb_target_architecture = QPushButton(self.groupBox)
        self.pb_target_architecture.setObjectName(u"pb_target_architecture")
        sizePolicy1.setHeightForWidth(self.pb_target_architecture.sizePolicy().hasHeightForWidth())
        self.pb_target_architecture.setSizePolicy(sizePolicy1)
        self.pb_target_architecture.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_7.addWidget(self.pb_target_architecture, 0, 0, 1, 1)

        self.pb_codesign_identity = QPushButton(self.groupBox)
        self.pb_codesign_identity.setObjectName(u"pb_codesign_identity")
        sizePolicy1.setHeightForWidth(self.pb_codesign_identity.sizePolicy().hasHeightForWidth())
        self.pb_codesign_identity.setSizePolicy(sizePolicy1)
        self.pb_codesign_identity.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_7.addWidget(self.pb_codesign_identity, 0, 1, 1, 1)

        self.pb_osx_bundle_identifier = QPushButton(self.groupBox)
        self.pb_osx_bundle_identifier.setObjectName(u"pb_osx_bundle_identifier")
        sizePolicy1.setHeightForWidth(self.pb_osx_bundle_identifier.sizePolicy().hasHeightForWidth())
        self.pb_osx_bundle_identifier.setSizePolicy(sizePolicy1)
        self.pb_osx_bundle_identifier.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_7.addWidget(self.pb_osx_bundle_identifier, 0, 2, 1, 1)

        self.pb_osx_entitlements_file = QPushButton(self.groupBox)
        self.pb_osx_entitlements_file.setObjectName(u"pb_osx_entitlements_file")
        sizePolicy1.setHeightForWidth(self.pb_osx_entitlements_file.sizePolicy().hasHeightForWidth())
        self.pb_osx_entitlements_file.setSizePolicy(sizePolicy1)
        self.pb_osx_entitlements_file.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_7.addWidget(self.pb_osx_entitlements_file, 1, 0, 1, 1)

        self.cb_argv_emulation = QCheckBox(self.groupBox)
        self.cb_argv_emulation.setObjectName(u"cb_argv_emulation")
        sizePolicy1.setHeightForWidth(self.cb_argv_emulation.sizePolicy().hasHeightForWidth())
        self.cb_argv_emulation.setSizePolicy(sizePolicy1)
        self.cb_argv_emulation.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        self.pb_add_resource = QPushButton(self.groupBox_2)
        self.pb_add_resource.setObjectName(u"pb_add_resource")
        sizePolicy1.setHeightForWidth(self.pb_add_resource.sizePolicy().hasHeightForWidth())
        self.pb_add_resource.setSizePolicy(sizePolicy1)
        self.pb_add_resource.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_8.addWidget(self.pb_add_resource, 0, 0, 1, 1)

        self.pb_add_xml_file = QPushButton(self.groupBox_2)
        self.pb_add_xml_file.setObjectName(u"pb_add_xml_file")
        sizePolicy1.setHeightForWidth(self.pb_add_xml_file.sizePolicy().hasHeightForWidth())
        self.pb_add_xml_file.setSizePolicy(sizePolicy1)
        self.pb_add_xml_file.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_8.addWidget(self.pb_add_xml_file, 0, 1, 1, 1)

        self.cb_uac_admin_apply = QCheckBox(self.groupBox_2)
        self.cb_uac_admin_apply.setObjectName(u"cb_uac_admin_apply")
        sizePolicy1.setHeightForWidth(self.cb_uac_admin_apply.sizePolicy().hasHeightForWidth())
        self.cb_uac_admin_apply.setSizePolicy(sizePolicy1)
        self.cb_uac_admin_apply.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_8.addWidget(self.cb_uac_admin_apply, 1, 0, 1, 1)

        self.cb_uac_uiaccess = QCheckBox(self.groupBox_2)
        self.cb_uac_uiaccess.setObjectName(u"cb_uac_uiaccess")
        sizePolicy1.setHeightForWidth(self.cb_uac_uiaccess.sizePolicy().hasHeightForWidth())
        self.cb_uac_uiaccess.setSizePolicy(sizePolicy1)
        self.cb_uac_uiaccess.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_8.addWidget(self.cb_uac_uiaccess, 1, 1, 1, 1)

        self.cb_hide_console = QCheckBox(self.groupBox_2)
        self.cb_hide_console.setObjectName(u"cb_hide_console")
        sizePolicy1.setHeightForWidth(self.cb_hide_console.sizePolicy().hasHeightForWidth())
        self.cb_hide_console.setSizePolicy(sizePolicy1)
        self.cb_hide_console.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))

        self.gridLayout_8.addWidget(self.cb_hide_console, 1, 2, 1, 1)
        ...
        self.lb_use_py_pyinstaller_auto_conda = QLabel(self.widget_27)
        self.lb_use_py_pyinstaller_auto_conda.setObjectName(u"lb_use_py_pyinstaller_auto_conda")
        ...
        sizePolicy20.setHeightForWidth(self.lb_use_py_pyinstaller_auto_conda.sizePolicy().hasHeightForWidth())
        self.lb_use_py_pyinstaller_auto_conda.setSizePolicy(sizePolicy20)

        self.horizontalLayout_22.addWidget(self.lb_use_py_pyinstaller_auto_conda)
        ...
        sizePolicy21.setHeightForWidth(self.wdg_win_setting.sizePolicy().hasHeightForWidth())
        self.wdg_win_setting.setSizePolicy(sizePolicy21)
        ...
        self.widget_29 = QWidget(self.wdg_win_setting)
        ...
        self.horizontalLayout_31 = QHBoxLayout(self.widget_29)
        self.horizontalLayout_31.setSpacing(10)
        self.horizontalLayout_31.setObjectName(u"horizontalLayout_31")
        self.horizontalLayout_31.setContentsMargins(5, 5, 5, 5)
        self.lb_print_cmd_option = QLabel(self.widget_29)
        self.lb_print_cmd_option.setObjectName(u"lb_print_cmd_option")
        sizePolicy19.setHeightForWidth(self.lb_print_cmd_option.sizePolicy().hasHeightForWidth())
        self.lb_print_cmd_option.setSizePolicy(sizePolicy19)

        self.horizontalLayout_31.addWidget(self.lb_print_cmd_option)

        self.cb_print_cmd_auto_open_folder = QCheckBox(self.widget_29)
        self.cb_print_cmd_auto_open_folder.setObjectName(u"cb_print_cmd_auto_open_folder")
        sizePolicy11.setHeightForWidth(self.cb_print_cmd_auto_open_folder.sizePolicy().hasHeightForWidth())
        self.cb_print_cmd_auto_open_folder.setSizePolicy(sizePolicy11)
        self.cb_print_cmd_auto_open_folder.setChecked(True)

        self.horizontalLayout_31.addWidget(self.cb_print_cmd_auto_open_folder)

        self.cb_print_cmd_auto_open_file = QCheckBox(self.widget_29)
        self.cb_print_cmd_auto_open_file.setObjectName(u"cb_print_cmd_auto_open_file")
        sizePolicy11.setHeightForWidth(self.cb_print_cmd_auto_open_file.sizePolicy().hasHeightForWidth())
        self.cb_print_cmd_auto_open_file.setSizePolicy(sizePolicy11)
        self.cb_print_cmd_auto_open_file.setChecked(True)

        self.horizontalLayout_31.addWidget(self.cb_print_cmd_auto_open_file)

        self.widget_41 = QWidget(self.widget_29)
        self.widget_41.setObjectName(u"widget_41")
        sizePolicy22 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy22.setHorizontalStretch(48)
        sizePolicy22.setVerticalStretch(0)
        sizePolicy22.setHeightForWidth(self.widget_41.sizePolicy().hasHeightForWidth())
        self.widget_41.setSizePolicy(sizePolicy22)
        ...
        sizePolicy23.setVerticalStretch(10)
        sizePolicy23.setHeightForWidth(self.wdg_currnt_env.sizePolicy().hasHeightForWidth())
        self.wdg_currnt_env.setSizePolicy(sizePolicy23)
        ...
        sizePolicy24.setHorizontalStretch(30)
        sizePolicy24.setVerticalStretch(0)
        sizePolicy24.setHeightForWidth(self.lb_env_current_path_title_page_setting_env.sizePolicy().hasHeightForWidth())
        self.lb_env_current_path_title_page_setting_env.setSizePolicy(sizePolicy24)
        ...
        sizePolicy25 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        sizePolicy25.setHorizontalStretch(14)
        sizePolicy25.setVerticalStretch(0)
        sizePolicy25.setHeightForWidth(self.widget_44.sizePolicy().hasHeightForWidth())
        self.widget_44.setSizePolicy(sizePolicy25)
        ...
        sizePolicy23.setHeightForWidth(self.wdg_env_specified.sizePolicy().hasHeightForWidth())
        self.wdg_env_specified.setSizePolicy(sizePolicy23)
        ...
        sizePolicy1.setHeightForWidth(self.pb_env_specified_browser_page_setting_env.sizePolicy().hasHeightForWidth())
        self.pb_env_specified_browser_page_setting_env.setSizePolicy(sizePolicy1)
        ...
        sizePolicy26.setHeightForWidth(self.widget_56.sizePolicy().hasHeightForWidth())
        self.widget_56.setSizePolicy(sizePolicy26)
        ...
        sizePolicy24.setHeightForWidth(self.rb_env_conda.sizePolicy().hasHeightForWidth())
        self.rb_env_conda.setSizePolicy(sizePolicy24)
        ...
        sizePolicy23.setHeightForWidth(self.wdg_env_builtin.sizePolicy().hasHeightForWidth())
        self.wdg_env_builtin.setSizePolicy(sizePolicy23)
        ...
        sizePolicy23.setHeightForWidth(self.widget_35.sizePolicy().hasHeightForWidth())
        self.widget_35.setSizePolicy(sizePolicy23)
        ...
        sizePolicy23.setHeightForWidth(self.wdg_save_setting.sizePolicy().hasHeightForWidth())
        self.wdg_save_setting.setSizePolicy(sizePolicy23)
        ...
        sizePolicy23.setHeightForWidth(self.widget_launch.sizePolicy().hasHeightForWidth())
        self.widget_launch.setSizePolicy(sizePolicy23)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pb_output_exe_version_edit.setText(QCoreApplication.translate("MainWindow", u"\u521b\u5efa/\u7f16\u8f91/\u9884\u89c8", None))
        ...
        self.pb_add_file_folder_data.setText(QCoreApplication.translate("MainWindow", u"\u6dfb\u52a0\u6587\u4ef6\u8d44\u6e90", None))
        self.pb_add_binary_data.setText(QCoreApplication.translate("MainWindow", u"\u6dfb\u52a0\u4e8c\u8fdb\u5236\u8d44\u6e90", None))
        self.pb_collect_submodules.setText(QCoreApplication.translate("MainWindow", u"\u6536\u96c6\u5b50\u6a21\u5757", None))
        self.pb_collect_data.setText(QCoreApplication.translate("MainWindow", u"\u6536\u96c6\u6570\u636e\u6587\u4ef6", None))
        self.pb_collect_binaries.setText(QCoreApplication.translate("MainWindow", u"\u6536\u96c6\u4e8c\u8fdb\u5236\u6587\u4ef6", None))
        self.pb_collect_all.setText(QCoreApplication.translate("MainWindow", u"\u6536\u96c6\u6240\u6709\u6a21\u5757\u8d44\u6e90", None))
        self.pb_add_splash_screen.setText(QCoreApplication.translate("MainWindow", u"\u6dfb\u52a0\u542f\u52a8\u753b\u9762", None))
        self.widget_81.setProperty(u"wdg_group", QCoreApplication.translate("MainWindow", u"area_widget", None))
        self.pb_hidden_import.setText(QCoreApplication.translate("MainWindow", u"\u6307\u5b9a\u6a21\u5757\u5bfc\u5165\u8def\u5f84", None))
        self.pb_imports_paths.setText(QCoreApplication.translate("MainWindow", u"\u6307\u5b9a\u6a21\u5757\u641c\u5bfb\u8def\u5f84", None))
        self.pb_exclude_module.setText(QCoreApplication.translate("MainWindow", u"\u6392\u9664\u6a21\u5757", None))
        self.widget.setProperty(u"wdg_group", QCoreApplication.translate("MainWindow", u"area_widget", None))
        self.pb_copy_metadata.setText(QCoreApplication.translate("MainWindow", u"\u590d\u5236\u5305\u7684\u5143\u6570\u636e", None))
        self.pb_recursive_copy_metadata.setText(QCoreApplication.translate("MainWindow", u"\u9012\u5f52\u590d\u5236\u5305\u7684\u5143\u6570\u636e", None))
        self.widget_33.setProperty(u"wdg_group", QCoreApplication.translate("MainWindow", u"area_widget", None))
        self.pb_additional_hooks_dir.setText(QCoreApplication.translate("MainWindow", u"\u989d\u5916\u7684\u94a9\u5b50\u8def\u5f84", None))
        self.pb_runtime_hook.setText(QCoreApplication.translate("MainWindow", u"\u8fd0\u884c\u65f6\u7684\u94a9\u5b50", None))
        self.widget_82.setProperty(u"wdg_group", QCoreApplication.translate("MainWindow", u"area_widget", None))
        self.pb_runtime_tmpdir.setText(QCoreApplication.translate("MainWindow", u"\u8fd0\u884c\u5de5\u4f5c\u8def\u5f84", None))
        self.pb_workpath_option.setText(QCoreApplication.translate("MainWindow", u"\u6784\u5efa\u65f6\u5de5\u4f5c\u76ee\u5f55", None))
        self.pb_specpath.setText(QCoreApplication.translate("MainWindow", u"SPEC \u6587\u4ef6\u751f\u6210\u8def\u5f84", None))
        self.cb_noupx_option.setText(QCoreApplication.translate("MainWindow", u"\u7981\u7528 UPX \u538b\u7f29", None))
        self.pb_upx_dir.setText(QCoreApplication.translate("MainWindow", u"UPX \u538b\u7f29\u5de5\u5177\u8def\u5f84", None))
        self.pb_upx_exclude.setText(QCoreApplication.translate("MainWindow", u"UPX \u6392\u9664\u6587\u4ef6", None))
        self.widget_80.setProperty(u"wdg_group", QCoreApplication.translate("MainWindow", u"area_widget", None))
        self.pb_log_level.setText(QCoreApplication.translate("MainWindow", u"\u65e5\u5fd7\u7ea7\u522b", None))
        self.pb_python_option.setText(QCoreApplication.translate("MainWindow", u"Python \u9009\u9879", None))
        self.pb_debug_mode.setText(QCoreApplication.translate("MainWindow", u"\u8c03\u8bd5\u9009\u9879", None))
        self.cb_disable_traceback.setText(QCoreApplication.translate("MainWindow", u"\u7981\u7528\u7a97\u53e3\u5316\u56de\u6eaf", None))
        self.cb_ignore_signals.setText(QCoreApplication.translate("MainWindow", u"\u5ffd\u7565\u4fe1\u53f7\u5904\u7406", None))
        self.cb_noconfirm_option.setText(QCoreApplication.translate("MainWindow", u"\u81ea\u52a8\u786e\u8ba4", None))
        self.cb_strip_option.setText(QCoreApplication.translate("MainWindow", u"\u53bb\u9664\u7b26\u53f7\u8868", None))
        self.cb_clean_cache.setText(QCoreApplication.translate("MainWindow", u"\u6e05\u7406\u7f13\u5b58", None))
        ...
        self.pb_target_architecture.setText(QCoreApplication.translate("MainWindow", u"\u6307\u5b9a\u67b6\u6784", None))
        self.pb_codesign_identity.setText(QCoreApplication.translate("MainWindow", u"\u6307\u5b9a\u4ee3\u7801\u7b7e\u540d", None))
        self.pb_osx_bundle_identifier.setText(QCoreApplication.translate("MainWindow", u"\u8bbe\u7f6e\u552f\u4e00\u6807\u8bc6\u7b26", None))
        self.pb_osx_entitlements_file.setText(QCoreApplication.translate("MainWindow", u"\u6307\u5b9a Entitlements \u6587\u4ef6", None))
        self.cb_argv_emulation.setText(QCoreApplication.translate("MainWindow", u"\u542f\u7528argv\u6a21\u62df", None))
        ...
        self.pb_add_resource.setText(QCoreApplication.translate("MainWindow", u"\u6dfb\u52a0\u989d\u5916\u8d44\u6e90", None))
        self.pb_add_xml_file.setText(QCoreApplication.translate("MainWindow", u"\u6dfb\u52a0\u6e05\u5355\u6587\u4ef6", None))
        self.cb_uac_admin_apply.setText(QCoreApplication.translate("MainWindow", u"\u7533\u8bf7\u7ba1\u7406\u5458\u6743\u9650", None))
        self.cb_uac_uiaccess.setText(QCoreApplication.translate("MainWindow", u"\u7533\u8bf7 UIAccess \u6743\u9650", None))
        self.cb_hide_console.setText(QCoreApplication.translate("MainWindow", u"\u9690\u85cf\u63a7\u5236\u53f0\u7a97\u53e3", None))
        ...
        self.lb_use_py_pyinstaller_auto_conda.setText(QCoreApplication.translate("MainWindow", u"\u547d\u4ee4\u884c\u6267\u884c\u65b9\u5f0f", None))
        ...
        self.lb_print_cmd_option.setText(QCoreApplication.translate("MainWindow", u"\u6253\u5370\u5b8c\u547d\u4ee4\u884c\u540e", None))
        self.cb_print_cmd_auto_open_folder.setText(QCoreApplication.translate("MainWindow", u"\u81ea\u52a8\u6253\u5f00\u6587\u4ef6\u5939", None))
        self.cb_print_cmd_auto_open_file.setText(QCoreApplication.translate("MainWindow", u"\u81ea\u52a8\u6253\u5f00\u6587\u4ef6", None))
        ...
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"\u4fdd\u5b58", None))
